...
* Macros
global outpath "$dropbox/finer_geo/scratch/atlanta"  
...
*Grad Rates
xtile pctile_grad = gradrate_r [w = cty_pop2000], nq(100)
...
replace order=4 if cat=="int"
replace order=3 if cat=="two"
replace order=2 if cat=="middle"
replace order=1 if cat=="stud_teach"
sort order

label define factors 5 `"Social Capital"' 4 `"Racial Integration"' ///
	3 `"Two-Parent Households"' 2 `"Size of Middle Class"' 1 `"Teacher-Student Ratio"'
